...
- **`references/typescript/nexus.md`** - TypeScript SDK Nexus APIs (Public Preview): Service contracts, sync/async Operation handlers, caller-side Nexus client, deadline propagation, cancellation
