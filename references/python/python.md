...
- **`references/python/nexus.md`** - Python SDK Nexus APIs: Service contracts, sync/async Operation handlers, caller-side Nexus client, exception classes, cancellation
